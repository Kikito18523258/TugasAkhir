        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/kelasSatu">Kelas 1</a>
                        <a class="collapse-item" href="/kelasDua">Kelas 2</a>
                        <a class="collapse-item" href="/kelasTiga">Kelas 3</a>
                        <a class="collapse-item" href="/kelasEmpat">Kelas 4</a>
                        <a class="collapse-item" href="/kelasLima">Kelas 5</a>
                        <a class="collapse-item" href="/kelasEnam">Kelas 6</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="rpp" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Fitur :</h6>
                        <a class="collapse-item" href="/programSemester">Program Semester</a>
                        <a class="collapse-item" href="/pembelajaranMingguan">Pembelajaran Mingguan</a>
                        <a class="collapse-item" href="/pembelajaranHarian">Pembelajaran Harian</a>
                    </div>
                </div>
            </li>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre> 
                                    ...
                                    src="img/undraw_profile.svg" style="padding-left: 5px" >
                                </a>
