...
<div style="margin: 3%;">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">{{$namaMapel->nama }} / Kelas {{$k}}</h1>  
                <a href="/kompetensiDasar/{{$k}}/{{$m}}/create" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-book fa-sm text-white-50"></i> Tambah Data</a>         
            </div>
    <table class="table">
